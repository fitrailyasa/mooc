...
use App\Http\Controllers\Admin\AdminQuestionResultController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware([Admin::class])->name('admin.')->prefix('admin')->group(function () {
        ...
        // QUESTION RESULT
        Route::get('/question-result', [AdminQuestionResultController::class, 'index'])->name('question-result.index');
    });
...
// Route::get('/mooc', [MoocController::class, 'index'])->name('mooc');
