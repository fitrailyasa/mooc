...
class ExpertiseExport implements FromCollection, WithHeadings, WithStyles, ShouldAutoSize
{
    public function collection()
    {
        ...
        foreach ($categories as $Expertise) {
            $collection[] = [
                'No' => $no++,
                'Name' => $Expertise->name ?? '',
            ];
        ...
        array_unshift($collection, ['Data Expertise'], ['']);
